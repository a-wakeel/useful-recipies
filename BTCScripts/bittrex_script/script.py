...
def get_data():
    ...
    try:
        ...
        res = requests.get('https://bittrex.com/api/v1.1/public/getmarketsummaries', headers=headers)
...
def parse_data(data):
    ...
    :return: string
    """
    parsed_data = "Market Name  :  Difference"
...
def main():
    ...
    while True:
        ...
        data_count = 0
        while data_count < len(market_data['result']):
            latest_buy_order = updated_market_data['result'][data_count]['OpenBuyOrders']
            previous_buy_order = market_data['result'][data_count]['OpenBuyOrders']
            rate_difference = latest_buy_order - previous_buy_order

            if rate_difference >= RATE_DIFFERENCE:
                result = {'MarketName': updated_market_data['result'][data_count]['MarketName'],
